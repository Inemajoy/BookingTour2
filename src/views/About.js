...
import Aboutbg from "../assets/images/aboutimg.jpg";
...
const About = () => {
  return (
    ...
    padding: "30px"
      ...
      <div style={{alignContent:"center", padding:"0rem 15rem 0rem 15rem"}}>
      <Title><h2 style={{textAlign:"center", color:"green"}}>this video will change your understanding to Rwanda Booking Tours</h2></Title>
        <iframe
